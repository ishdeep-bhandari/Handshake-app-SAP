...
//  Handshake
//
//  Created by Bhandari, Ishdeep on 3/1/16.
...
class EventTableViewController: UITableViewController,MFMailComposeViewControllerDelegate,SavingViewControllerDelegate{
...
//    var resultSearchController = UISearchController(searchResultsController: nil)
 ...
 /*   func filterContentForSrechText(searchText: String, scope: String = "All"){
        filtereddetails = details.filter{ data in
    ...
    override func viewDidLoad() {
        ...
        refresher.addTarget(self, action: #selector(EventTableViewController.refresh), forControlEvents: UIControlEvents.ValueChanged)
 ...
 /*   if (self.resultSearchController.active){
  ...
  /*   override func tableView(tableView: UITableView, titleForHeaderInSection section: Int) -> String? {
    ...
    override func tableView(tableView: UITableView, editActionsForRowAtIndexPath indexPath: NSIndexPath) -> [UITableViewRowAction]? {
        ...
        let mail  = UITableViewRowAction(style: .Normal, title:  "\u{2709}\n Forward") { action, index in
        ...
        mail.backgroundColor = UIColor(red: 12.0/255.0, green: 15.0/255.0, blue: 15.0/255.0, alpha: 1.0)
        ...
        feedback.backgroundColor = UIColor(red: 12.0/255.0, green: 15.0/255.0, blue: 15.0/255.0, alpha: 1.0)
    ...
    override func tableView(tableView: UITableView, cellForRowAtIndexPath indexPath: NSIndexPath) -> UITableViewCell {
         ...
         let cell = tableView.dequeueReusableCellWithIdentifier("programmaticCell", forIndexPath: indexPath)
        /*  if (self.resultSearchController.active) {
 ...
 /*   override func tableView(tableView: UITableView, willDisplayCell cell: UITableViewCell, forRowAtIndexPath indexPath: NSIndexPath) {
        ...
        let todaycomponents = calendar.components([.Month], fromDate: todaydate)
        let todaymonth = todaycomponents.month
        let sectioncomponents = calendar.components([.Month], fromDate: sortedsections[indexPath.row])
        let sectionmonth = sectioncomponents.month
        if (sectionmonth == todaymonth)
        {
    ...
    override func prepareForSegue(segue: UIStoryboardSegue, sender: AnyObject?) {
       ...
       /*     if (self.resultSearchController.active) {
          ...
          //  }
            ...
            viewController.objectidret = sentdata.objectid
        }
      /*  else if (segue.identifier == "FeedBackView") {
            
            let viewController = segue.destinationViewController as! UINavigationController
            let feedview = viewController.topViewController as! FeedbackViewController
            let indexPath = tableView.indexPathForSelectedRow
            let sentdata : TableData
            /*     if (self.resultSearchController.active) {
             sentdata = filtereddetails[indexPath.row]
            ...
            sentdata = eventlist[sortedsections[indexPath!.section]]![indexPath!.row]
            //  }
            feedview.titleevent = sentdata.title
        }*/
